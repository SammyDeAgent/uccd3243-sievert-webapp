...
/**
 * The primary key class for the department_manager database table.
 * 
 */
@Embeddable
public class DepartmentManagerPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DepartmentManagerPK)) {
			return false;
		}
		DepartmentManagerPK castOther = (DepartmentManagerPK)other;
		return 
