...
//@NamedQuery(name="Employee.findById2", query="SELECT DISTINCT e FROM Employee e JOIN FETCH e.titles WHERE e.id = :id")
//@NamedQuery(name="Employee.findById3", query="SELECT DISTINCT e FROM Employee e JOIN FETCH e.departmentEmployees WHERE e.id = :id")
